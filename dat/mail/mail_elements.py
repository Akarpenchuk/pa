...
RECOVERY_EMAIL = "//div[contains(text(),'Восстановление пароля на modnaKasta')][last()]"
LAST_EMAIL_TIME = "//div[contains(@class,'hidden-xs')]//div[@class='innermail ng-binding']"
# DELETE_ALL_EMAILS = "//button[@title='Delete']"
DELETE_ALL_EMAILS = "//button[@title='Delete']/i"
# DELETE_ALL_EMAILS = "//button[@title='Delete']/parent::*"
